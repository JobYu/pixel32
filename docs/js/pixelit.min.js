  ...
  for (var e = 0; e < a.height; e++)
    for (var h = 0; h < a.width; h++) {
      var r = 4 * e * a.width + 4 * h,
        colorKey = a.data[r] + ',' + a.data[r + 1] + ',' + a.data[r + 2];
      colorCounts[colorKey] = (colorCounts[colorKey] || 0) + 1;
    }

  // Sort colors by occurrence and take top 32
  topColors = Object.keys(colorCounts)
    .sort((a, b) => colorCounts[b] - colorCounts[a])
    .slice(0, 128) // Limit to 32 colors
    .map(color => color.split(',').map(Number));

  // Use topColors as the new palette
  this.palette = topColors;
